...
public class Characters {
	...
	public Characters(){
		characters = new TreeMap<String, Character>(); //Characters name, all of its qualities are stored in the Character object which is the value.
	}
	/**
